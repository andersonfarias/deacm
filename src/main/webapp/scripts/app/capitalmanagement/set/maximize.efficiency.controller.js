...
angular.module('dEACMApp')
    .controller('SetDMUMaximizeEfficiencyController', function ($scope, $modal, $state, $stateParams, Principal, CapitalManagement) {
        ...
        $scope.execute = function(){
        	...
        	$modal.open({
                ...
                resolve: {
                	...
                	capital: function(){ return parseFloat($scope.capital); },
                	kaoDistance: function() { return $scope.kaoDistance; },
                	td: function(){ return null; },
                                ...
                                resolve: {
                                	...
                                	executeFunction: function() {
                                		return function(dmus, targets, capital, kaoDistance, td, executeWithSuperefficiency, mode){
                                			CapitalManagement.setDMUMaxEfficiency(
                                        			{
                                        				"targets": targets, "dmus": dmus, "capital": capital,
                                        				"kaoDistance": kaoDistance, "executeWithSuperEfficiency": executeWithSuperefficiency,
                                        				"mode": mode
                                        			},
                                        			function(result){
                                        				$state.go('home.set-maximize-efficiency.result', { "solution": result });
                                        			},
                                        			function(error){
