...
angular.module('dEACMApp')
    .controller('SetDMUMaximizeEfficiencyResultController', function ($scope, $modal, $state, $stateParams, Principal, CapitalManagement) {
        ...
        $scope.goBack = function(){
        	...
        	$state.go( 'home.set-maximize-efficiency' , {
    			"dmus" : $scope.dmus, "kaoDistance": $scope.kaoDistance, "capital": $scope.capital
        	} );
        };

        $scope.chooseAnotherModel = function(){
        	$state.go( 'home.models' , { "dmus": $scope.dmus, "kaoDistance": $scope.kaoDistance, "capital": $scope.capital } );
        };
