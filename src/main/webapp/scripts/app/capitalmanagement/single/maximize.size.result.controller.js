...
angular.module('dEACMApp')
    .controller('SingleDMUMaximizeSizeResultController', function ($scope, $modal, $state, $stateParams, Principal, CapitalManagement) {
        ...
        $scope.goBack = function(){
        	...
        	$state.go( 'home.single-maximize-size' , {
    			"dmus" : $scope.dmus, "kaoDistance": $scope.kaoDistance,
    			"ke": $scope.ke, "dmu0": indexDmu0, "capital": $scope.minCapital
        	} );
        };
