...
angular.module('dEACMApp')
    .controller('SingleDMUMaximizeEfficiencyResultController', function ($scope, $modal, $state, $stateParams, Principal, CapitalManagement) {
        ...
        $scope.goBack = function(){
        	...
        	$state.go( 'home.single-maximize-efficiency' , {
    			"dmus" : $scope.dmus, "kaoDistance": $scope.kaoDistance,
    			"ks": $scope.ks, "dmu0": indexDmu0, "capital": $scope.minCapital
        	} );
        };
