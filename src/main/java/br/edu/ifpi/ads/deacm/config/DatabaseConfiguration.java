...
import br.edu.ifpi.ads.deacm.config.liquibase.AsyncSpringLiquibase;
import liquibase.integration.spring.SpringLiquibase;

@Configuration
@EnableJpaRepositories( "br.edu.ifpi.ads.deacm.repository" )
@EnableJpaAuditing( auditorAwareRef = "springSecurityAuditorAware" )
@EnableTransactionManagement
@EnableElasticsearchRepositories( "br.edu.ifpi.ads.deacm.repository.search" )
public class DatabaseConfiguration {
	...
	public DataSource dataSource( DataSourceProperties dataSourceProperties, JHipsterProperties jHipsterProperties ) {
		...
		if ( dataSourceProperties.getUsername() != null ) {
			...
			config.addDataSourceProperty( "user", "" ); // HikariCP doesn't
														// allow null user
		}
