...
public final class SetDMUEfficiencyMaximizationSolution implements Solution {
	...
	public SetDMUEfficiencyMaximizationSolution( Double capital, Double kaoDistance, List<DMU> dmus, List<DMU> targets, DataFrame inputsOffsets, DataFrame outputsOffsets, boolean executeWithSuperEfficiency, ModelMode mode ) {
		super();
